...
{
    public class AllBooksAdapter : BaseAdapter<Book>
    {
        private readonly Activity context;
        private readonly List<Book> books;

        public AllBooksAdapter(Activity context, List<Book> books)
        {
            this.books = books;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (row == null)
            {
                row = LayoutInflater.From(context).Inflate(Resource.Layout.list_book_row, null, false);
            }
